...
ActiveRecord::Schema.define(version: 20160831142840) do
  ...
  add_index "votes", ["dilemma_id"], name: "index_votes_on_dilemma_id", using: :btree
  add_index "votes", ["user_id"], name: "index_votes_on_user_id", using: :btree

  add_foreign_key "dilemmas", "users"
  add_foreign_key "votes", "dilemmas"
